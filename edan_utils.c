...
PRIVATE int get_weight_package(char *message_addr, Results *result_package) {
    // Find related header
    char *weight_start_addr = strstr(message_addr, weight_header);
    if (!weight_start_addr)
        return ARG_NOT_FOUND_ERROR;
...
PRIVATE int get_height_package(char *message_addr, Results *result_package) {
...
PRIVATE int get_heart_rate(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_pulse_rate(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_nibp_sys(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_nibp_dia(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_nibp_map(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_nibp_pr(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_spo2(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_perfusion_index(char *message_addr, Results *result_package) {
    // Find related header
    ...
    // Allocate the memory block to handle conversion operation.
    char *perfusion_index_val_str = (char *) malloc(
            (perfusion_index_val_end_addr - perfusion_index_val_start_addr) * sizeof(char));
...
PRIVATE int get_rr_interval(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_temperature(char *message_addr, Results *result_package) {
    // Find related header
...
PRIVATE int get_full_name(char *message_addr, Results *result_package) {
...
PUBLIC void print_result_package_2(Results *result_package) {
    printf("%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%.1f\t\t%.1f\t\t%s\n",
           (*result_package).heart_rate_in_bpm,
           (*result_package).pulse_rate_in_bpm,
           (*result_package).spo2_in_percentage,
           (*result_package).perfusion_index,
